...
urlpatterns = [
    ...
    # =====================================================
    # FRONTEND HTML PAGES (avec et sans .html)
    # =====================================================
    ...
    path('etuinscri.html', TemplateView.as_view(template_name='etuinscri.html')),
    path('dashboard/mentor/', TemplateView.as_view(template_name='dashboardmentor.html'), name='dashboard_mentor'),
    path('dashboardmentor.html', TemplateView.as_view(template_name='dashboardmentor.html')),
    path('dashbordmentor.html', TemplateView.as_view(template_name='dashboardmentor.html')),
    path('dashboard/mentee/', TemplateView.as_view(template_name='dashboardmentee.html'), name='dashboard_mentee'),
    path('dashboardmentee.html', TemplateView.as_view(template_name='dashboardmentee.html')),
    path('rapport/', TemplateView.as_view(template_name='rapport.html'), name='rapport'),
    path('rapport.html', TemplateView.as_view(template_name='rapport.html')),
